...
const AboutSection = () => (
  <section id="about" className="py-20 bg-muted" aria-label="About us">
    <div className="container px-4">
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
        <article className="bg-card rounded-lg p-8 text-center shadow-sm border">
          <Building className="w-10 h-10 text-primary mx-auto mb-4" aria-hidden="true" />
        ...
        <article className="bg-card rounded-lg p-8 text-center shadow-sm border">
          <ShieldCheck className="w-10 h-10 text-trust mx-auto mb-4" aria-hidden="true" />
        ...
        <article className="bg-card rounded-lg p-8 text-center shadow-sm border">
          <Award className="w-10 h-10 text-accent mx-auto mb-4" aria-hidden="true" />
